import { SyncDescriptor, SyncDescriptor0 } from '../DI/descriptors';
...
import { LinkedList } from '../DI/linkedList';
import { ServiceCollection } from '../DI/serviceCollection';
import type { Event } from '../DI/event';
import { GlobalIdleValue } from '../DI/async';
import { toDisposable } from '../DI/lifecycle';
...
export class Trace {
  ...
  stop() {
    ...
    console.log(Trace.all.forEach((n) => console.log(n)));
  }
}
